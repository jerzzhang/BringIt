		...
		plugins: {
			layers: {
				menuPanel: {
					...
					height: '100%',
					hidden: true,
					html:	'<h2>Favorite Orders</h2><span class="closer" data-action="toggleLayer" data-args="menuPanel">Close</span><div data-action="moveElement" data-args="menuPanel-content"></div>',
					orientation: 'vertical',
					position: 'top-right',
					side: 'right',
					width: { small: '20em', global: '30em' }
				}
			}
		}
	});
